...
class DashboardState extends Equatable {
  ...
  const DashboardState({this.isRevenueGraph, this.revenueReport,this.ordersReport,this.isOrdersReport,this.apiFetchStatus});
  ...
  @override
  List<Object?> get props => [revenueReport, isRevenueGraph,ordersReport,isOrdersReport,apiFetchStatus];
}
