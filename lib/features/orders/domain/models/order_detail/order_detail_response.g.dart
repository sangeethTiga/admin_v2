...
_$OrderDetailResponseImpl _$$OrderDetailResponseImplFromJson(
  ...
  parcelCharge: json['parcel_charge'] as String?,
  ...
  spotDiscountPercentage: json['spot_discount_percentage'] as String?,
  spotDiscountAmt: json['spot_discount_amt'] as String?,
  ...
  amountInCash: parseNumberAsDouble(json['amount_in_cash']),
  timeCash: json['time_cash'] as String?,
  amountByCard: parseNumberAsDouble(json['amount_by_card']),
  timeCard: json['time_card'] as String?,
  netAmountWalletMoney: json['net_amount_wallet_money'] as String?,
  netAmountWalletPoints: json['net_amount_wallet_points'] as String?,
  ...
  nonTaxableAmt: json['non_taxable_amt'] as String?,
  orderDiscPercentage: json['order_disc_percentage'] as String?,
  arabicNameSettings: (json['ArabicNameSettings'] as num?)?.toInt(),
  taxSettings: (json['taxSettings'] as num?)?.toInt(),
  taxName: json['tax_name'] as String?,
  orderTaxPercentage: parseNumberAsDouble(json['order_tax_percentage']),
  orderDiscAmount: json['order_disc_amount'] as String?,
  taxAmount: json['tax_amount'] as String?,
  shippingCharge: json['shipping_charge'] as String?,
  weightScale: json['weight_scale'] as String?,
  cancelItemAmount: json['cancel_item_amount'] as String?,
  ...
  surgeAmt: json['surge_amt'] as String?,
  ...
  zip: parseInt(json['zip']),
  countryId: (json['country_id'] as num?)?.toInt(),
  stateId: (json['state_id'] as num?)?.toInt(),
  phoneNo: parseInt(json['phone_no']),
  ...
  parcelChargeEnabled: parseNumberAsDouble(json['parcel_charge_enabled']),
);
...
_$ProductOrderItemImpl _$$ProductOrderItemImplFromJson(
  ...
  servicePrice: parseNumberAsDouble(json['service_price']),
  orderStatusId: (json['order_status_id'] as num?)?.toInt(),
  orderStatusName: json['order_status_name'] as String?,
  ...
  shippingCharge: parseNumberAsDouble(json['shipping_charge']),
  isTaxable: (json['is_taxable'] as num?)?.toInt(),
  isTaxInclusive: (json['is_tax_inclusive'] as num?)?.toInt(),
  taxAmt: json['tax_amt'],
  orderTaxPercentage: parseNumberAsDouble(json['order_tax_percentage']),
  ...
  productTaxAmt: json['product_tax_amt'] as String?,
  productTaxPercentage: parseNumberAsDouble(json['product_tax_percentage']),
  productFeatured: (json['product_featured'] as num?)?.toInt(),
  productShortDescription: json['product_short_description'] as String?,
  prodShipCharge: parseNumberAsDouble(json['prod_ship_charge']),
  itemsPerPack: parseNumberAsDouble(json['items_per_pack']),
  ...
  prodHeight: parseInt(json['prod_height']),
  prodWidth: parseInt(json['prod_width']),
  prodLength: parseInt(json['prod_length']),
  prodWeight: parseInt(json['prod_weight']),
  ...
  ignoreDiscount: parseNumberAsDouble(json['ignore_discount']),
  ...
  changePrice: parseNumberAsDouble(json['change_price']),
  ...
  preOrderFee: parseNumberAsDouble(json['pre_order_fee']),
...
_$VariantImpl _$$VariantImplFromJson(Map<String, dynamic> json) =>
    _$VariantImpl(
      ...
      vOfferToDate: json['v_offer_to_date'] as String?,
