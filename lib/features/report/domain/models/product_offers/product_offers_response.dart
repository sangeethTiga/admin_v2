...
class ProductOffersResponse with _$ProductOffersResponse {
  const factory ProductOffersResponse({
    ...
    @JsonKey(name: "branch_name") dynamic branchName,
    @JsonKey(name: "offer_status_id") int? offerStatusId,
    @JsonKey(name: "offer_type") dynamic offerType,
    ...
    @JsonKey(name: "price_type_code") String? priceTypeCode,
  }) = _ProductOffersResponse;

  factory ProductOffersResponse.fromJson(Map<String, dynamic> json) =>
      _$ProductOffersResponseFromJson(json);
}
