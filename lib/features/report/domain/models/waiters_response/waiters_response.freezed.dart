...
WaitersResponse _$WaitersResponseFromJson(Map<String, dynamic> json) {
  return _WaitersResponse.fromJson(json);
}

/// @nodoc
mixin _$WaitersResponse {
  ...
  /// Serializes this WaitersResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of WaitersResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $WaitersResponseCopyWith<WaitersResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WaitersResponseCopyWith<$Res> {
  factory $WaitersResponseCopyWith(
    WaitersResponse value,
    $Res Function(WaitersResponse) then,
  ) = _$WaitersResponseCopyWithImpl<$Res, WaitersResponse>;
  @useResult
  $Res call({
...
/// @nodoc
class _$WaitersResponseCopyWithImpl<$Res, $Val extends WaitersResponse>
    implements $WaitersResponseCopyWith<$Res> {
  _$WaitersResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$WaitersResponseImplCopyWith<$Res>
    implements $WaitersResponseCopyWith<$Res> {
  factory _$$WaitersResponseImplCopyWith(
    _$WaitersResponseImpl value,
    $Res Function(_$WaitersResponseImpl) then,
  ) = __$$WaitersResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    @JsonKey(name: "user_id") int? userId,
...
/// @nodoc
class __$$WaitersResponseImplCopyWithImpl<$Res>
    extends _$WaitersResponseCopyWithImpl<$Res, _$WaitersResponseImpl>
    implements _$$WaitersResponseImplCopyWith<$Res> {
  __$$WaitersResponseImplCopyWithImpl(
    _$WaitersResponseImpl _value,
    $Res Function(_$WaitersResponseImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$WaitersResponseImpl implements _WaitersResponse {
  const _$WaitersResponseImpl({
  ...
  factory _$WaitersResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$WaitersResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'WaitersResponse(userId: $userId, storeId: $storeId, companyUsersId: $companyUsersId, userName: $userName, userGender: $userGender, userEmail: $userEmail, userRoleId: $userRoleId, userPhone: $userPhone, userPwd: $userPwd, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt, isSynced: $isSynced)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$WaitersResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$WaitersResponseImplCopyWith<_$WaitersResponseImpl> get copyWith =>
      __$$WaitersResponseImplCopyWithImpl<_$WaitersResponseImpl>(
        this,
        _$identity,
      );
  ...
  Map<String, dynamic> toJson() {
    return _$$WaitersResponseImplToJson(this);
  }
}

abstract class _WaitersResponse implements WaitersResponse {
  const factory _WaitersResponse({
  ...
  factory _WaitersResponse.fromJson(Map<String, dynamic> json) =
      _$WaitersResponseImpl.fromJson;
